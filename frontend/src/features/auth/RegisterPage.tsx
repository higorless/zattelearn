    ...
    <div className="flex h-screen bg-background items-center justify-center">
      ...
      >
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-muted-foreground/50">Crie sua conta</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-7">
          ...
          >
            {isPending
              ? <><Loader2 className="h-3.5 w-3.5 animate-spin mr-2" />Criando conta...</>
              : 'Criar conta'
            }
          </Button>
        </form>
        ...
        <p className="text-xs text-muted-foreground/45 text-center">
          Já tem uma conta?{' '}
          <Link to="/login" className="text-muted-foreground/70 hover:text-foreground underline underline-offset-4 transition-colors">
            Entrar
          </Link>
        </p>
      </motion.div>
